...
12프레임 합계 **719,774px → 213,864px**. 표는 `pnpm diff`가 그대로 낸다.
...
| ARCHIVE (책장) | 7.343% | **2.239%** |
| My Page | 7.837% | **1.006%** |
| ARCHIVE (복습 표) | 4.932% | **2.487%** |
| LEARNING QUEST | 4.188% | **2.155%** |
| 계정정보 | 4.699% | **0.679%** |
| Friend's Room | 4.366% | **1.184%** |
| main | 2.607% | **1.786%** |
| My Room | 2.008% | **0.910%** |
| Deco | 1.354% | **0.808%** |
...
**남은 것 — Deco 코인 (1.354% → 0.808%, 그래도 crop 적용 전후로 이 프레임만 나빠졌던 자리).** 23×23 코인 9개가 `w 0.6028 h 0.6152`
