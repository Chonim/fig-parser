...
12프레임 합계 **719,774px → 523,871px**. 표는 `pnpm diff`가 그대로 낸다.
...
| 프레임 | 처음 | 지금 |
| --- | ---: | ---: |
| My Item | 11.304% | **4.052%** |
| ARCHIVE (책장) | 7.343% | **6.877%** |
| My Page | 7.837% | **5.405%** |
| ARCHIVE (복습 표) | 4.932% | **3.477%** |
| LEARNING QUEST | 4.188% | **3.674%** |
| 계정정보 | 4.699% | **3.755%** |
| Friend's Room | 4.366% | **3.574%** |
| main | 2.607% | 2.616% |
| My Room | 2.008% | **1.744%** |
| Deco | 1.354% | 1.630% |
| LEARNING QUEST (빈 상태) | 1.283% | **0.947%** |
| Login | 0.146% | 0.146% |
...
**남은 것 — Deco 코인 (1.354% → 1.630%).** 23×23 코인 9개가 `w 0.6028 h 0.6152`
